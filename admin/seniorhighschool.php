...
<body>
	...
	<div class = "container-fluid">	
		<div class = "panel panel-default">
            ...
            <div class = "alert alert-info">Senior High School</div>

				<a class = "btn btn-success disabled"><span class = "badge"><?php echo $f_p['total']?></span> Pendings</a>
				<a class = "btn btn-info" href = ""><span class = "badge"><?php echo $f_ci['total']?></span> Accepted</a>
                <a class = "btn btn-danger" href = ""><span class = "badge"><?php echo $f_ci['total']?></span> decline</a>
