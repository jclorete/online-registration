			...
			<div class = "panel-body">
				<div class = "alert alert-info">Registration/ College</div>
                    ...
                    <div class = "form-inline" style = "float:left; margin-left:20px;">
						...
						<br />
						<input type = "number" name="Mobile" value = "" class = "form-control" size = "40" required/>
					</div>

                    <br style = "clear:both;"/>
                    <br/>
                    <div class="form-inline" name="Course">
                    <label>Course</label>
						<br />
                    ...
                    <div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Tel./Mobile #</label>
						<br />
						<input type = "test" name="g_Mobile" value = "" class = "form-control" size = "40" required/>
					</div>
                    <br style = "clear:both;"/>
					<br />
                    ...
                    <div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Tel./Mobile #</label>
						<br />
						<input type = "number" name="e_Mobile" value = "" class = "form-control" size = "40" required/>
					</div>
                    <br style = "clear:both;"/>
					<br />
					...
					<?php
                    require_once('add_query_college.php');
                    ?>
				</div>
			</div>
		</div>
