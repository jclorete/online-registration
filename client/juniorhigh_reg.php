		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Registration/ Junior High School</div>
					<form method = "POST" enctype = "multipart/form-data" action="insert_juniorhigh.php">
                ...
                <br style = "clear:both;"/>
                    ...
                    <div class = "form-inline" style = "float:left; margin-left:20px;">
						...
						<br />
						<input type = "text" value = "" class = "form-control" name="guardian_adress" size = "40" />
					</div>
                    <div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Tel./Mobile #</label>
						<br />
						<input type = "text" value = "" class = "form-control" name="g_mobile" size = "40" />
					</div>
                    <br style = "clear:both;"/>
					<br />
                    ...
                    <div class = "form-inline" style = "float:left;">
						<label>Name</label>
						<br />
						<input type = "text" value = "" class = "form-control" name="e_name" size = "40" required/>
					</div>
                    <div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Adress</label>
						<br />
						<input type = "text" value = "" class = "form-control" name="e_adress" size = "40" required/>
					</div>
                    <div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Tel./Mobile #</label>
						<br />
						<input type = "text" value = "" class = "form-control" name="e_mobile" size = "40" required/>
					</div>
                    <br style = "clear:both;"/>
					<br />
                    ...
                    <div class = "form-inline" style = "float:left;">
						<label>Name</label>
						<br />
						<input type = "text" value = "" class = "form-control" name="s_name" size = "40" required/>
					</div>
                    <div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Grade/Year</label>
						<br />
						<input type = "text" value = "" class = "form-control" name="grade" size = "40" required/>
					</div>
                    <br style = "clear:both;"/>
                    <div class = "form-inline" style = "float:left;">
						<label>Name</label>
						<br />
						<input type = "text" value = "" class = "form-control" size = "40" required/>
					</div>
                    <div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Grade/Year</label>
						<br />
					...
					<?php require_once 'insert_juniorhigh.php'?>
				</div>
			</div>
		</div>
	<br />
